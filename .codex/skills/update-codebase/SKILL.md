...
### `domains/index.md` and `infra/index.md`

- These files are generated by `./.gtd/scripts/generate-index.sh`
- Do not edit them manually
- If the script is missing, recreate it based on these requirements:
