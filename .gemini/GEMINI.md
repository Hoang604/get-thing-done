...
- **Step 2 (Alignment Contract)**: When user answers Step 1 questions, you must read quality mechanism from [code-quality.md](file:///home/hoang/.gemini/config/skills/code-quality.md). Then output a single unified bulleted contract explicitly stating exactly 4 checkable elements: (1) exact problem/intent, (2) Targets summary: `Targets: <concrete action description> [basenameA](file:///path/basenameA)\n<concrete action description> [basenameB](file:///path/basenameB),...`, (3) deterministic technical choices (locked data models, exact parameters, singular execution path), and (4) active quality mechanisms.
