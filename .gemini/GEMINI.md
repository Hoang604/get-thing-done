...
- When user prompt contains question mark or inquiring intent:
  1. First line of response MUST be exact sequence below (keep backticks):
     `[QUESTION_DETECTED]`
  2. Insert line break immediately after sequence.
  3. Answer question using plain text below line break.
